...
def get_dictionary_data(category):
    if category == 'glasses':
        ...
        return pd.DataFrame([
            {'id': 101, 'brand': '미광', 'name': '클리어 원데이', 'price': 32000, 'qty': '30p', 'img': 'https://via.placeholder.com/300x200?text=Clear+1-Day', 'spec_mat': 'Hioxifilcon A', 'spec_water': '58%', 'spec_dk': '25', 'spec_bc': '8.7', 'desc': '가성비 최고의 데일리 렌즈.', 'tags': ['#가성비갑', '#입문용'], 'dry': 4, 'handle': 9, 'oxygen': 3},
            {'id': 102, 'brand': '쿠퍼비전', 'name': '클래리티 원데이', 'price': 45000, 'qty': '30p', 'img': 'https://via.placeholder.com/300x200?text=Clarity+1-Day', 'spec_mat': 'Somofilcon A', 'spec_water': '56%', 'spec_dk': '86', 'spec_bc': '8.6', 'desc': '실리콘 하이드로겔 소재의 가성비 모델.', 'tags': ['#실리콘', '#가성비', '#숨쉬는렌즈'], 'dry': 7, 'handle': 7, 'oxygen': 8},
            {'id': 103, 'brand': '인터로조', 'name': '오투오투 원데이', 'price': 45000, 'qty': '30p', 'img': 'https://via.placeholder.com/300x200?text=O2O2+1-Day', 'spec_mat': 'Silicone Hydrogel', 'spec_water': '45%', 'spec_dk': '130', 'spec_bc': '8.8', 'desc': '높은 산소전달률을 자랑하는 국산 프리미엄.', 'tags': ['#국산', '#고산소', '#수지렌즈'], 'dry': 7, 'handle': 8, 'oxygen': 9},
            {'id': 104, 'brand': '바슈롬', 'name': '울트라 원데이', 'price': 55000, 'qty': '30p', 'img': 'https://via.placeholder.com/300x200?text=Ultra+1-Day', 'spec_mat': 'Kalifilcon A', 'spec_water': '55%', 'spec_dk': '134', 'spec_bc': '8.6', 'desc': '16시간 촉촉함 유지.', 'tags': ['#장시간착용', '#디지털기기', '#촉촉함'], 'dry': 8, 'handle': 8, 'oxygen': 9},
            {'id': 105, 'brand': '아큐브', 'name': '오아시스 원데이', 'price': 63000, 'qty': '30p', 'img': 'https://via.placeholder.com/300x200?text=Oasys+1-Day', 'spec_mat': 'Senofilcon A', 'spec_water': '38%', 'spec_dk': '121', 'spec_bc': '8.5/9.0', 'desc': '전 세계 베스트셀러.', 'tags': ['#베스트셀러', '#PC업무', '#믿고쓰는'], 'dry': 8, 'handle': 8, 'oxygen': 9},
            {'id': 106, 'brand': '알콘', 'name': '데일리스 토탈원', 'price': 69000, 'qty': '30p', 'img': 'https://via.placeholder.com/300x200?text=Total1', 'spec_mat': 'Delefilcon A', 'spec_water': '33%~80%', 'spec_dk': '156', 'spec_bc': '8.5', 'desc': '워터렌즈, 건조감 해결의 끝판왕.', 'tags': ['#강소라렌즈', '#건조감종결', '#프리미엄'], 'dry': 10, 'handle': 4, 'oxygen': 10},
            {'id': 107, 'brand': '알콘', 'name': '토탈원 난시', 'price': 79000, 'qty': '30p', 'img': 'https://via.placeholder.com/300x200?text=Total1+Toric', 'spec_mat': 'Delefilcon A', 'spec_water': '33%', 'spec_dk': '127', 'spec_bc': '8.6', 'desc': '토탈원의 촉촉함에 난시 교정.', 'tags': ['#난시교정', '#프리미엄', '#촉촉함'], 'dry': 10, 'handle': 4, 'oxygen': 9},
            {'id': 108, 'brand': '아큐브', 'name': '오아시스 난시', 'price': 74000, 'qty': '30p', 'img': 'https://via.placeholder.com/300x200?text=Oasys+Toric', 'spec_mat': 'Senofilcon A', 'spec_water': '38%', 'spec_dk': '121', 'spec_bc': '8.5', 'desc': '선명한 난시 교정.', 'tags': ['#난시교정', '#축안정', '#운동할때'], 'dry': 8, 'handle': 8, 'oxygen': 9}
        ])
...
def load_recommendation_data(mode, sph=0, cyl=0):
    if mode == 'glasses':
        ...
        # [KeyError Fix] handling, oxygen 등 모든 점수 키값 포함
        data = [
...
# ==============================================================================
    ...
    for label, val, desc in metrics:
        ...
        st.caption(f"{val}점 | {desc}") # 바로 아래 설명 추가
