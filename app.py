...
def get_dictionary_data(category):
    if category == 'glasses':
        return pd.DataFrame([
            {'id': 1, 'brand': '케미', 'name': '퍼펙트 UV', 'price': 30000, 'price_table': {'1.56 (중굴절)': 30000, '1.60 (고굴절)': 60000, '1.67 (초고굴절)': 90000, '1.74 (특초)': 150000}, 'img': 'https://via.placeholder.com/300x200?text=CHEMI+Perfect+UV', 'spec_design': '비구면', 'spec_material': 'NK-55/MR-8', 'spec_coat': 'Perfect UV', 'spec_uv': 'UV400', 'desc': '자외선 99.9% 및 블루라이트 차단 가성비 렌즈.', 'tags': ['#가성비', '#청광차단'], 'thin': 6, 'view': 6, 'coat': 5},
            ...
            {'id': 3, 'brand': '호야', 'name': '뉴럭스', 'price': 70000, 'price_table': {'1.60 (고굴절)': 70000, '1.67 (초고굴절)': 110000}, 'img': 'https://via.placeholder.com/300x200?text=HOYA+Nulux', 'spec_design': 'Trueform', 'spec_material': 'Eyas 1.60', 'spec_coat': 'VG(Venus Guard)', 'spec_uv': 'UV Ban', 'desc': '스크래치에 강한 고강도 코팅.', 'tags': ['#흠집방지', '#고강도'], 'thin': 7, 'view': 8, 'coat': 9},
            {'id': 4, 'brand': '케미', 'name': '양면비구면 D-Free', 'price': 80000, 'price_table': {'1.60 (고굴절)': 80000, '1.67 (초고굴절)': 110000}, 'img': 'https://via.placeholder.com/300x200?text=CHEMI+D-Free', 'spec_design': '양면비구면', 'spec_material': 'MR-8', 'spec_coat': 'Aegis', 'spec_uv': 'Perfect UV', 'desc': '주변부 왜곡을 줄여 눈이 덜 작아 보임.', 'tags': ['#미용효과', '#난시교정'], 'thin': 8, 'view': 8, 'coat': 7},
            {'id': 5, 'brand': '자이스', 'name': '클리어뷰', 'price': 100000, 'price_table': {'1.60 (고굴절)': 100000, '1.67 (초고굴절)': 140000}, 'img': 'https://via.placeholder.com/300x200?text=ZEISS+ClearView', 'spec_design': 'Freeform', 'spec_material': 'Zeiss', 'spec_coat': 'Platinum', 'spec_uv': 'UVProtect', 'desc': '3배 더 넓은 선명한 시야.', 'tags': ['#초선명', '#자이스'], 'thin': 8, 'view': 9, 'coat': 8},
            ...
            {'id': 8, 'brand': '자이스', 'name': '드라이브세이프', 'price': 250000, 'price_table': {'1.50 (일반)': 250000, '1.60 (고굴절)': 360000}, 'img': 'https://via.placeholder.com/300x200?text=ZEISS+DriveSafe', 'spec_design': 'Luminance', 'spec_material': 'Zeiss', 'spec_coat': 'DriveSafe', 'spec_uv': 'UVProtect', 'desc': '야간 운전 시 눈부심 감소 및 선명한 시야.', 'tags': ['#야간운전', '#안전운전'], 'thin': 8, 'view': 10, 'coat': 9}
        ])
    else:
        return pd.DataFrame([
            ...
            {'id': 103, 'brand': '인터로조', 'name': '오투오투 원데이', 'price': 45000, 'qty': '30p', 'img': 'https://via.placeholder.com/300x200?text=O2O2', 'spec_mat': 'Silicone', 'spec_water': '45%', 'spec_dk': '130', 'spec_bc': '8.8', 'desc': '높은 산소전달률을 자랑하는 국산 프리미엄.', 'tags': ['#국산'], 'dry': 7, 'handle': 8, 'oxygen': 9},
